# Installation file adapted from posh-git https://github.com/dalbyk/posh-git

param([switch]$WhatIf = $false)

if($PSVersionTable.PSVersion.Major -lt 2) {
    Write-Warning "PSShortcuts requires PowerShell 2.0 or better; you have version $($Host.Version)."
    return
}
...
Write-Host 'PSShortcuts sucessfully installed!'
